...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@XYZ.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+977 9813284718</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">XYZ <span>XYZ</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<div class="col-md-12 book-form-left-w3layouts text-light bg-dark" <style>>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">XYZ XYZ</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our XYZ XYZ</h3> 
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Ram Parsad</h4>
							<span>Manager</span>
							<p>Use the present simple tense to explain what you do every day. Use 'have' or 'have got' to speak about your children, pets, etc. Use 'a' the first time you mention something. For example, I live in a house. Then use 'the' after the first time you write about it.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+977 9813284718</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:info@xyzxyz.com">INFO@xyzxyz.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Tirpureshwore, Kathmandu, Nepal</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d883.2065595745705!2d85.33087301447829!3d27.691764899105006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19bcf04610ad%3A0x2ede2456b58716eb!2sAdarsa%20Marg-1%2C%20Kathmandu%2044600!5e0!3m2!1sen!2snp!4v1656570523196!5m2!1sen!2snp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
